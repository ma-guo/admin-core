...
type DocumentItem struct {
	...
	Name     string `json:"name" zpf_name:"name"`                         //	名称
	Markdown string `json:"markdown" zpf_name:"markdown" zpf_reqd:"true"` //	markdown内容
...
// 分页查询内容管理信息
type DocumentPageRsp struct {
	Total int64           `json:"total" zpf_name:"total" zpf_reqd:"true"` //	总数
	Items []*DocumentItem `json:"items" zpf_name:"items"`                 //	内容管理信息
}

// 分页查询草稿信息
type DocumentDragePageReq struct {
	DocId int64 `json:"doc_id" zpf_name:"doc_id" zpf_reqd:"true" zpf_minnum:"1"` //	文章ID 最小值:1
	Page  int   `json:"page" zpf_name:"page" zpf_reqd:"true" zpf_minnum:"1"`     //	页码 最小值:1
	Size  int   `json:"size" zpf_name:"size" zpf_reqd:"true" zpf_num:"1 50"`     //	每页数量 数值范围:1-50
}

// 请求内容管理信息
type DocumentFormReq struct {
