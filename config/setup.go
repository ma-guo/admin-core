...
func initDatabaseData() error {
	lines := []string{
		...
		"INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `path`, `component`, `perm`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `always_show`, `keep_alive`) VALUES (113, 1, '0,1', 'API权限', 1, 'apiviews', 'system/apiview/index', '', 1, 7, 'api', '', '2024-11-27 12:14:50', '2024-11-27 12:16:17', 0, 1);",
		"INSERT INTO `admincore`.`sys_role_menu` (`role_id`, `menu_id`) VALUES (2, 113);",
	}
	if MainDB == nil {
		return nil
	}
