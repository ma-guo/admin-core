...
import (
	"github.com/ma-guo/admin-core/utils/pongo2gin"

	apiViews "github.com/ma-guo/admin-core/app/v1/views"
	webViews "github.com/ma-guo/admin-core/app/web/views"
...
func (admin *AdminBoot) RegisterModules(svr *niuhe.Server) {
	...
	svr.RegisterModule(webViews.GetModule())
	templatesDir := config.Config.Templates
	if templatesDir == "" {
		templatesDir = "templates"
	}
	svr.GetGinEngine().HTMLRender = pongo2gin.Default(templatesDir)
